...
namespace LVE {
	...
	void LVE_Camera::setViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 up) {
	...
	void LVE_Camera::setViewTarget(glm::vec3 position, glm::vec3 target, glm::vec3 up) {
		setViewDirection(position, target - position, up);
	}

	void LVE_Camera::setViewYXZ(glm::vec3 position, glm::vec3 rotation) {
