...
namespace LVE {
    ...
    void LVE_Pipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo)
    {
        ...
        configInfo.bindingDescriptions = LVE_Model::Vertex::getBindingDescriptions();
        configInfo.attributeDescriptions = LVE_Model::Vertex::getAttributeDescriptions();
    }

    void LVE_Pipeline::enableAlphaBlending(PipelineConfigInfo& configInfo)
    {
